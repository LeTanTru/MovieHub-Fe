...
export default function AccountLayout({ children }: { children: ReactNode }) {
  return (
    <>
      ...
      <Container className='max-1536:min-h-[calc(100vh-72px)] max-520:min-h-[calc(100vh-64px)] relative z-2 mx-auto flex min-h-[calc(100vh-90px)] w-full max-w-400 flex-col justify-center'>
        {children}
