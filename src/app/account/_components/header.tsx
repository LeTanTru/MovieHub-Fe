...
export default function Header() {
  ...
  return (
    <header className='header relative top-0 right-0 left-0 z-10 block'>
      <div
        className={
          'max-1600:pl-6 max-1600:pr-8 max-1360:pl-4 max-1360:pr-6 flex items-center justify-between bg-transparent pr-10 pl-8 transition-all duration-200 ease-linear max-lg:px-4'
        }
      >
        ...
        <div className='h-header flex items-center gap-2 max-[520px]:h-18'>
