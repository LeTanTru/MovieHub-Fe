                ...
                >
                  ...
                  {isAuthor && (
                    <ConfirmModal
                      ...
                      trigger={
                        <button className='max-640:text-[13px] max-520:text-xs flex w-full cursor-pointer items-center gap-2 px-4 py-2 text-black transition-all duration-200 ease-linear hover:bg-gray-300 hover:text-rose-500'>
                          <FaTrash />
                          Xóa đánh giá
                        </button>
                      }
