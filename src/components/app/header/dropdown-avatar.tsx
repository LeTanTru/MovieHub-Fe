      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            animate='animate'
            exit='exit'
            className='bg-background absolute top-20 right-1 mt-2 w-48 rounded-md shadow-[0px_0px_6px_2px_var(--accent)] before:absolute before:-top-4 before:right-0 before:left-0 before:h-4 before:w-full before:bg-transparent before:content-[""]'
          >
