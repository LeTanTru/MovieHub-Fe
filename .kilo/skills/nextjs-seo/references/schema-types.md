  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": { "@type": "Answer", "text": "Next.js is a React framework for production." }
    },
    {
      "@type": "Question",
      "name": "Is Next.js good for SEO?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes, Next.js supports SSG, SSR, and ISR which are all great for SEO." }
    }
  ]
}
```
