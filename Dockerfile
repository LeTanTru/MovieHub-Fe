...
ARG NEXT_PUBLIC_API_MEDIA_ENDPOINT_URL
ARG NEXT_PUBLIC_TENANT_ID
ARG NEXT_PUBLIC_API_GOOGLE_LOGIN_CALLBACK
ARG NEXT_PUBLIC_URL
...
ENV NEXT_PUBLIC_API_MEDIA_ENDPOINT_URL=$NEXT_PUBLIC_API_MEDIA_ENDPOINT_URL
ENV NEXT_PUBLIC_TENANT_ID=$NEXT_PUBLIC_TENANT_ID
ENV NEXT_PUBLIC_API_GOOGLE_LOGIN_CALLBACK=$NEXT_PUBLIC_API_GOOGLE_LOGIN_CALLBACK
